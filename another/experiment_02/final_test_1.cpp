...
void seek_digit::calulateCommand_test(){
	...
	if( (&m_laserscan)->ranges.size() > 0)
	  {
		...
		double target_x = 24.15;
		double target_y = -41.26;
		double vel_linear=0.30;
